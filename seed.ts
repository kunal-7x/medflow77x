...
import { generateLargeDataset } from './src/lib/mockDataGenerator';
...
async function seed() {
  ...
  function getId(oldId: string | null | undefined): string | null {
